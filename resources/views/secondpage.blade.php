...
<body>
    <h3>please fill the required infromation below <b><u>per passport</u></b></h3>
    ...
    <form action="/thirdpage" method="POST">
        <div class="form-group">
            @csrf
            <h4>Please chose your accommodation preference as you are eligible for (5-night)</h4>

            {{--  checkIn date  --}}
            <div class="col-md-6">
                <label>check in date</label>
                <input type="date" name="checkInDate" id="checkInDate" class="form-control mb-2" required>
            </div>

            {{--  checkOut date  --}}
            <div class="col-md-6">
                <label>check out date</label>
                <input type="date" name="checkOutDate" id="checkOutDate" class="form-control mb-2" required>
            </div>

            <div class="col-md-6">
                <select type="text" name="roomType" id="roomType">
...
<script>
    ...
    let checkMinDate = new Date();
    let checkMaxDate = new Date();
    checkMaxDate.setDate(checkMinDate.getDate() + 5);

    checkOutDate.min = formatDate(checkMinDate);
    checkOutDate.max = formatDate(checkMaxDate);
